import{_ as s,o as n,c as a,O as l}from"./chunks/framework.571309da.js";const F=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/MyBatis/整合mybatisplus.md","filePath":"guide/MyBatis/整合mybatisplus.md","lastUpdated":null}'),p={name:"guide/MyBatis/整合mybatisplus.md"},e=l(`<p><strong>实现步骤：</strong></p><p><strong>导入jar包：</strong></p><div class="language-xml"><button title="Copy Code" class="copy"></button><span class="lang">xml</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">dependencies</span><span style="color:#89DDFF;">&gt;</span></span>
