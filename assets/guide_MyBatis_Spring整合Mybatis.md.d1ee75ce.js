import{_ as s,o as n,c as a,O as l}from"./chunks/framework.571309da.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/MyBatis/Spring整合Mybatis.md","filePath":"guide/MyBatis/Spring整合Mybatis.md","lastUpdated":1689910169000}'),p={name:"guide/MyBatis/Spring整合Mybatis.md"},e=l(`<h3 id="_1-基于xml方式整合mybatis" tabindex="-1">1 基于xml方式整合mybatis <a class="header-anchor" href="#_1-基于xml方式整合mybatis" aria-label="Permalink to &quot;1 基于xml方式整合mybatis&quot;">​</a></h3><p>实现步骤：</p><p>1、导入相关jar包</p><div class="language-text"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&lt;dependencies&gt;</span></span>
