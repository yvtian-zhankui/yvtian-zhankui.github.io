import{_ as s,o as a,c as n,O as l}from"./chunks/framework.571309da.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Spring/Bean的生命周期（了解）.md","filePath":"guide/Spring/Bean的生命周期（了解）.md","lastUpdated":null}'),o={name:"guide/Spring/Bean的生命周期（了解）.md"},p=l(`<p>问题导入</p><p>问题1：多例的Bean能够配置并执行销毁的方法？</p><p>问题2：如何做才执行Bean销毁的方法？</p><h3 id="_1-生命周期相关概念介绍" tabindex="-1">1 生命周期相关概念介绍 <a class="header-anchor" href="#_1-生命周期相关概念介绍" aria-label="Permalink to &quot;1 生命周期相关概念介绍&quot;">​</a></h3><ul><li><p>生命周期：从创建到消亡的完整过程</p></li><li><p>bean生命周期：bean从创建到销毁的整体过程</p></li><li><p>bean生命周期控制：在bean创建后到销毁前做一些事情</p></li></ul><h3 id="_2-代码演示" tabindex="-1">2 代码演示 <a class="header-anchor" href="#_2-代码演示" aria-label="Permalink to &quot;2 代码演示&quot;">​</a></h3><p>2.1 Bean生命周期控制</p><ul><li>提供生命周期控制方法</li></ul><div class="language-text"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">public class BookDaoImpl implements BookDao {</span></span>
