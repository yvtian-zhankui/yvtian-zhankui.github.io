...
<span class="line"><span style="color:#A6ACCD;">        &lt;tx:method name=&quot;*&quot;/&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">    &lt;/tx:attributes&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">&lt;/tx:advice&gt;</span></span></code></pre></div><p>其中，<a href="tx:method" target="_blank" rel="noreferrer">tx:method</a> 代表切点方法的事务参数的配置，例如：</p><div class="language-text"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&lt;tx:method name=&quot;transfer&quot; isolation=&quot;REPEATABLE_READ&quot; propagation=&quot;REQUIRED&quot; timeout=&quot;-1&quot; read-only=&quot;false&quot;/&gt;</span></span></code></pre></div><ul><li><p>name：切点方法名称</p></li><li><p>isolation:事务的隔离级别</p></li><li><p>propogation：事务的传播行为</p></li><li><p>timeout：超时时间</p></li><li><p>read-only：是否只读</p></li></ul><h3 id="_2-4-知识要点" tabindex="-1">2.4 知识要点 <a class="header-anchor" href="#_2-4-知识要点" aria-label="Permalink to &quot;2.4 知识要点&quot;">​</a></h3><p><strong>声明式事务控制的配置要点</strong></p><ul><li><p>平台事务管理器配置</p></li><li><p>事务通知的配置</p></li><li><p>事务aop织入的配置</p></li></ul><h3 id="_2-5-基于注解事务处理案例" tabindex="-1">2.5 基于注解事务处理案例 <a class="header-anchor" href="#_2-5-基于注解事务处理案例" aria-label="Permalink to &quot;2.5 基于注解事务处理案例&quot;">​</a></h3><p><strong>代码实现：</strong></p><pre><code>前期工作准备
...
4、测试运行
</code></pre><p><strong>实现步骤</strong></p><p>1、编辑jdbcConfig配置对事务处理的加载</p><div class="language-text"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">public class JdbcConfig {</span></span>
