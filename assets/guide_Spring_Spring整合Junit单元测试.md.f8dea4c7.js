import{_ as s,o as n,c as a,O as t}from"./chunks/framework.571309da.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Spring/Spring整合Junit单元测试.md","filePath":"guide/Spring/Spring整合Junit单元测试.md","lastUpdated":null}'),l={name:"guide/Spring/Spring整合Junit单元测试.md"},p=t(`<p>3.1 原始Junit测试Spring的问题</p><p>在测试类中，每个测试方法都有以下两行代码：</p><div class="language-text"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">ApplicationContext ac = new ClassPathXmlApplicationContext(&quot;application.xml&quot;);</span></span>
